...
#define POP3_LOGFILE    BBSHOME "/run/bpop3d.log"
#define POP3_PIDFILE    BBSHOME "/run/bpop3d.pid"
...
#define POP3_HELLO_MSG  "+OK MapleBBS POP3 server ready\r\n"
#define POP3_HELLO_LEN  (sizeof(POP3_HELLO_MSG) - 1)

#define POP3_BYE_MSG    "+OK MapleBBS POP3 server terminated\r\n"
