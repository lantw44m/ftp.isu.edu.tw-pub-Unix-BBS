...
#define	MAXTAGS		(512)		/* post/mail reader ¼ÐÅÒ¼Æ¥Ø¤§¤W­­ */
...
TagPruner()
{
  ...
  {
    getdata(b_lines, 0, "½T©w­n§R°£©Ò¦³¼ÐÅÒ«H¥ó¶Ü(Y/N)¡H[N] ",
      genbuf, 4, LCECHO,0);
    if (genbuf[0] != 'y')
      return RC_FOOT;
...
//          prints(msg_mailer);
          prints(COLOR2"  §Úªº«H½c  "COLOR1
      "[1m [33m(r)[37mÅª«H [33m(f)[37mÂà±H [33m(y)[37m¸s²Õ¦^«H "
      "[33m(d)[37m§R°£ [33m(c)[37m½Æ»s¤å³¹    [44m %13s [0m",
      cuser.userid);

       else
          prints(COLOR2"  ¤å³¹¿ïÅª  [46m  "
      "[33m(=[]<>)[37m¬ÛÃö¥DÃD [33m(/?)[37m·j´M¼ÐÃD "
      "[33m(aA)[37m·j´M§@ªÌ [33m(V)[37m§ë²¼ [44m %13s [0m",
      cuser.userid);
    }
    else
    {
