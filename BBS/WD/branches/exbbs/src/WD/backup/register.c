  ...
  time_t clock;
{
  ...
  /* new user should register in 2*60 mins */
  ...
  /* ¤@¯ë±¡ªp¡A«O¯d 360 ¤Ñ */
    ...
    return (urec->userlevel & PERM_LOGINOK ? 360 : 30) * 24 * 60 - value;
}
...
//  cuser.userlevel |= PERM_DEFAULT;
  ...
  if ( !HAS_PERM(PERM_LOGINOK) )
  {
    ...
    if (dashf(genbuf))
      cuser.userlevel |= ( PERM_POST | PERM_PAGE | PERM_CHAT | PERM_LOGINOK);
      cuser.userlevel &= (~PERM_FORBIDPOST);
