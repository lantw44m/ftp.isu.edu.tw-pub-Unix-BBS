...
#define HABIT_NEWUSER    (HABIT_MOVIE | HABIT_COLOR | HABIT_SAYALOHA | HABIT_BOARDLIST)
#define HABIT_GUEST	 (HABIT_MOVIE | HABIT_COLOR | HABIT_SAYALOHA | HABIT_SEELOG | HABIT_ALREADYSET)
/* ----------------------------------------------------- */
/* 各種喜好設定的中文意義                                */
/* ----------------------------------------------------- */
