...
#define BBSIMG          "wd.twbbs.org/image/title-b.jpg"
#define BBSIMG_S        "wd.twbbs.org/image/title-s.jpg"
#define BBSBACK         "wd.twbbs.org/image/bg.jpg"
...
/*nekobe*/
        ...
        printf("<TD><A HREF=mailto:%s.bbs@wd.twbbs.org>"
...
//    printf("<td align=left bgcolor=%s width=50>Ãþ«¬</td>", DBLUE);
    ...
    while(fread(&fhdr, sizeof(fhdr), 1, fp) && ++i) 
    {
      ...
      {	/* shakalaca.990816: ¦³­­¨îªº´N¤£­n°e¥X¥h¤F */
        ...
        printf("<tr>");
/*        printf("<td><img src=http://wd.twbbs.org/icons/%s></td>",
